...
set -g status-right "#[fg=#3E4452,bg=#282C34,nobold,nounderscore,noitalics]◖#[fg=#ABB2BF,bg=#3E4452] APM: #(python3 ~/.config/nvim/scripts/apm_client.py) #(uptime  | cut -d \" \" -f 1,2) #[fg=#98C379,bg=#3E4452,nobold,nounderscore,noitalics]◖#[fg=#282C34,bg=#98C379] #(whoami)@#H "
